...
{
#ifdef __DEBUG
//    M0P_GPIO->PA02_SEL_f.SEL = 1;
//    M0P_GPIO->PADIR_f.PA02 = 0;

//    M0P_UART1->SCNT = 52;//52;//时钟频率4M//625 48M
//    M0P_UART1->SCON_f.OVER = 1;
//		M0P_UART1->SCON_f.SM = 1;
    //uint32_t u32Pclk1 =  0;
...
void _ttywrch(int c)
{
   Uart_SendData(UARTCH0,(uint8_t)c); 
}
